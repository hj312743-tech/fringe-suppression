...
# ==========================================
# FFT-based stripe-orientation estimation
# ==========================================
def estimate_dominant_stripe_angles_from_image(img, topk=2, min_sep_deg=18, rmin=0.06, rmax=0.45):
    """
    Estimate the dominant frequency-normal angles of stripe patterns from the image spectrum.
...
# ==========================================
# Smooth notch-mask construction
# ==========================================
def build_smooth_notch_mask(
    ...
    """
    Build a smooth angular notch mask in the Fourier plane.
    angles_deg: list of frequency-normal angles in [0, 180).
    sigma_deg: angular width of the notch; larger values suppress a wider band.
    notch_depth: depth of the notch in [0, 1]; larger values give stronger suppression.
    """
    yy, xx = np.mgrid[0:H, 0:W]
    cy, cx = H // 2, W // 2
    y = yy - cy
...
def run_bp_fft_notch(
    ...
    # Use the final notched amplitude as the fixed Table 1 interface
